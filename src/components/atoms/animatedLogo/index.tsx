            ...
            <svg width="100%" height="100%" viewBox="0 0 3384 2075" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                    ...
                    <clipPath id="clip0_25_28">
                        <rect width="3384" height="2075" className={styles.logoelem5}></rect>
                    </clipPath>
                </defs>
            </svg>
