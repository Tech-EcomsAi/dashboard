...
import { TbChartHistogram, TbChartPie, TbChevronRightPipe, TbDeviceMobileShare, TbHelpCircle, TbLayoutSidebarLeftCollapse, TbNotes, TbPhoneCalling, TbUsers } from 'react-icons/tb';
import { BsPeople } from 'react-icons/bs';
import { MdDarkMode, MdLightMode, MdOutlineCampaign, MdOutlineNavigateNext, MdOutlineSettingsPhone, MdOutlineSettingsSuggest } from 'react-icons/md';
import { RiAccountPinCircleLine, RiArrowRightDoubleLine, RiArticleLine, RiExpandLeftLine, RiMoonFoggyLine } from 'react-icons/ri';
import { BiConversation, BiPhoneCall } from 'react-icons/bi';
            ...
            <motion.div
                ...
                <div className={styles.logoWrap}>
                    <div className={styles.logo}>
                        <img src="https://firebasestorage.googleapis.com/v0/b/auth-804f1.appspot.com/o/temp%2F3.png?alt=media&token=60c3717e-620e-4271-95d9-e67ad7b49cb4&_gl=1*1nacy0p*_ga*NjkzMDY5Mjk0LjE2OTc5OTM5MDk.*_ga_CW55HF8NVT*MTY5ODQ5ODA4NS42LjEuMTY5ODQ5ODE4Ni41My4wLjA." />
                    </div>
                </div>
                    ...
                    {navMenu.map((nav: NavItem, i: number) => {
                        return <Fragment key={i}>
                            <div className={`${styles.menuItemWrap} ${nav.key == activeNav.key ? styles.active : ""} ${styles[nav.key]}`}
                                ...
                                style={{
                                    background: `${(nav.key == activeNav.key) ? token.colorPrimaryBgHover : ((nav.key == hoverId || nav.key == activeParentNav.key) ? token.colorBgTextHover : token.colorBgBase)}`,
