...
import { NAVIGATION_COMPONENTS_LIST, PAGE_SECTION_SEPARATOR, SECTION_UID_SEPARATOR } from "../constants";
...
export default {
    ...
    uid: `${SECTIONS_LIST.NAVIGATION}${PAGE_SECTION_SEPARATOR}${NAVIGATION_COMPONENTS_LIST.NAVIGATION_ONE}${SECTION_UID_SEPARATOR}${uuid()}`,//uniqe id used for internal identifications => secionId + "#" + componentId
